...
public:
    ...
    void setEncodingName(const std::string & val) {
        encoding_name = val;
    }
    ...
    void setClockRate(uint32_t val) {
        clock_rate = val;
    }

    void addEncodingParam(const std::string & val) {
    ...
    void setEncodingParams(const std::vector<std::string> & params) {
